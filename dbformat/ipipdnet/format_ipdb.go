...
func Ipdb_NewWith(b []byte) (Locator, error) {
	loc := new(Ipdb_locator)
...
func (l *Ipdb_locator) Find(ipstr string) (*LocationInfo, error) {
...
func (l *Ipdb_locator) init(b []byte) error {
...
func (l *Ipdb_locator) nextNode(node uint32, right bool) uint32 {
...
func (l *Ipdb_locator) newLocationInfo(node uint32) *LocationInfo {
